...
public class LearnActivityAdapter extends RecyclerView.Adapter <LearnActivityAdapter.NoteViewHolder>{
    Context context;
    ArrayList<Note> notes;

    public LearnActivityAdapter(Context context, ArrayList<Note> notes) {
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, int i) {
        ...
        final Intent intent = new Intent(context, ReadNoteActivity.class);
